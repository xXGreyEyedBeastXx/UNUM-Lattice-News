...
Harassment, doxxing, dehumanization, unsupported accusations, collective blame, and operational assistance for violence are not.

## Rights

No general open-source or redistribution license is currently granted for original analysis, maps, editorial structures, or reports unless a specific file or release states otherwise.

Third-party materials remain under their respective rights and should be quoted, summarized, linked, or reproduced only within applicable permissions and with clear provenance.
