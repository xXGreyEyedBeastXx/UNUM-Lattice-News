...
PRIVACY_PROTECTIVE
DONOR_ANONYMITY_POLITICAL
STRUCTURAL_OPACITY
ACCOUNTABILITY_BYPASS_POSSIBLE
EVASION_ALLEGED
EVASION_SUPPORTED
SOURCE_RISK_UNKNOWN
```
...
investigation:
  question: ""
  scope: ""
  status: seed|active|hold|dormant|closed|reopened
  verdict: none|supported|weakened|disproven|insufficient_evidence
sources:
  primary: []
...
Empty fields are preferable to invented content.
